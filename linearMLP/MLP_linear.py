...
"""
adapted from website http://deeplearning.net/tutorial/mlp.html#mlp
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
             dataset='random_images.pkl.gz', batch_size=20, n_hidden=25):
    """
   ...
   """
    ...
    y = T.vector('y', dtype=theano.config.floatX)  # the labels are presented as 1D vector of
                        # float labels
